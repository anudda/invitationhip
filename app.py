...
# 프로필 바 (f-string 최소화)
st.markdown(f'<div class="profile-bar"><div class="profile-img"><img src="{b64_photos[0]}"></div><div class="user-id">jiyeon_is_coming_2026</div></div>', unsafe_allow_html=True)
